...
- [KEV wave 2026-09-09→14: NetScaler alternate-path auth bypass, MikroTik RouterOS pre-auth username-syntax privesc + btest memory leak, Cisco Secure Email Gateway email-parsing SQLi→root RCE, JFrog Artifactory scope/issuance drift, GitLab unauth commits-API file read, ScreenConnect client session gate (11 KEV entries, operator sweep angles)](2026-09-15-kev-wave-netscaler-cisco-routeros-jfrog-gitlab-screenconnect.md)
