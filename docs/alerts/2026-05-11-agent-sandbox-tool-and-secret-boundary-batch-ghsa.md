...
5. Disable or firewall legacy agent APIs and code-execution features until patched and covered by explicit authentication, authorization, and audit logging.
