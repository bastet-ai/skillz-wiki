...
- **Duplicate Teams sender-allowlist advisory** — [GHSA-8pf2-vj79-4wxg](https://github.com/advisories/GHSA-8pf2-vj79-4wxg): duplicate of the previously covered Teams Graph API sender-allowlist boundary issue.
...
1. Upgrade OpenClaw deployments to a build containing the relevant fixes, and deduplicate the duplicate GHSA IDs in tracking systems.
